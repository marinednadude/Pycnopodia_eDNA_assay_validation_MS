---
title: 'Lesperance eLowQuant LoD and LoQ: Hakai ddPCR 5 rep 3 droplets'
author: "Zachary Gold"
date: "2026-04-10"
...
DAT_RAW <- read.csv(FILE.PATH) %>% rename(SQ=TargetConcentration, Concentration=MeasuredConcentration) %>% 
  ...
  mutate(PositiveDroplets = if_else(PositiveDroplets < 3,0,PositiveDroplets)) %>% 
...
write.csv(xdxq.all.PR, file=here("LOD_LOQ","eLowQuant_Hakai_5rep_ddPCR_3_droplet.csv"), row.names = F)
```
